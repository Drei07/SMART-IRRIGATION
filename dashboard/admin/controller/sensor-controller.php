...
class Sensor
{
    ...
    public function sensorThresholds($sensorId, $sensorMode, $plant_id, $water_amount_am, $water_amount_pm,  $start_time_am, $start_time_pm, $selected_days){
        ...
        $stmt = $this->admin->runQuery('UPDATE sensors SET plant_id=:plant_id, mode=:mode, water_amount_am=:water_amount_am, water_amount_pm=:water_amount_pm, start_time_am=:start_time_am, start_time_pm=:start_time_pm, selected_days=:selected_days WHERE sensor_id=:sensor_id');
